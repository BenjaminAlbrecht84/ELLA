...
public class AlignmentStatisticsHelper {

    public static long n;
    public static double lnK;
    public static double K;
    public static double LAMBDA;
    public static final double LN2 = (float) Math.log(2);

    private static final String[] table = new String[]{"Matrix open extension lambda K H",
    ...
    public static final ArrayList<String> matrixList = new ArrayList<>();
    public static final HashMap<String, ArrayList<String>> matrix2penalties = new HashMap<>();
