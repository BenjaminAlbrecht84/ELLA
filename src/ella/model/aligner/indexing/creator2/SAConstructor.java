...
import ella.model.aligner.indexing.creator2.IndexCreator2.InputParser;
...
public class SAConstructor {
    ...
    private IndexCreator2 indexCreator;

    private SuffixArrayTable suffixArrayTable;

    public SAConstructor(IndexText text, int sepDepth, int p, int q, int cores, File outFile, IndexCreator2 indexCreator) {
        this.cores = cores;
